...
Unveil the new **name** and **website**! Background of the Community of Practice with founder, Mitchel Rudge.
...
[FAQ](https://quarto.org/docs/faq/rmarkdown.html) for Rmarkdown users.
...
Quarto Pub is a free publishing service for quarto content. It requires having a login and an access token. This is a relatively straight forward way to get your blog online. There are some limitations to the size and everythin published on Quarto Pub is **publicly visible**. The link above outlines the steps to publish with Quart Pub.

For this workshop, we will focus on Netlify and git + GitHub.

Enter:

## Part 2: Git - what is it?
